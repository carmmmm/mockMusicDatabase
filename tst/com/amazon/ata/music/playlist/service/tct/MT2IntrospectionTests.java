...
public class MT2IntrospectionTests {
    ...
    public void mt02_specificInvalidAttributeExceptions_shareParentInvalidAttributeException() {
        ...
        Class<?> valueParentException = valueException.getSuperclass(); //invalid attribute
        Class<?> changeParentException = changeException.getSuperclass(); //invalidattributechange
        ...
        Class<?> parentException = ClassQuery.inContainingPackage(BASE_PACKAGE)
            .withExactSimpleName(valueParentException.getSimpleName()) //invalid attribute
            .withSubTypeOf(RuntimeException.class)
            .findClassOrFail();
